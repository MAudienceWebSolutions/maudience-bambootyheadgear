	...
	<tr valign="top"><th scope="row"><?php _e( 'Enter some text for your site name' , 'framemarket'); ?></th>
		<td>
			...
			<?php if ( class_exists( 'MarketPress' ) ) {
				...
				<tr><th scope="row"><?php _e('Use gridmarket style when filter by "Order By"?', 'framemarket'); ?></th>
				 <td>
					 <label class="description"><input <?php echo ($options['show_grid_style'] == 'yes') ? 'checked' : '' ?> type="radio" name="framemarket_theme_options[show_grid_style]" value="yes" <?php echo $checked; ?> /> <?php _e('Yes', 'framemarket') ?> </label>
					 <label class="description"><input <?php echo ($options['show_grid_style'] == 'no') ? 'checked' : '' ?> type="radio" name="framemarket_theme_options[show_grid_style]" value="no" <?php echo $checked; ?> /> <?php _e('No', 'framemarket') ?> </label>
				 </td>
				 </tr>
